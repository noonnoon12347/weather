...
import 'package:weather/View/history_screen.dart';
...
class _WeatherAppHomeScreenState extends ConsumerState<WeatherAppHomeScreen> {
  ...
  Future<void> _fetchWeather() async {
    ...
    try {
      final forecast = await _weatherService.getHourForecast(city);
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Image.network(
                                "https://cdn-icons-png.flaticon.com/512/9342/9342300.png",
                                width: 30, height: 30,
                              ),
                              Text(
                          ...
                          Column(
                            ...
                            children: [
                              Image.network(
                                "https://cdn-icons-png.flaticon.com/512/17187/17187679.png",
                                width: 30, height: 30,
                              ),
                              Text(
                          ...
                          Column(
                            ...
                            children: [
                              Image.network(
                                "https://cdn-icons-png.freepik.com/512/7074/7074069.png",
                                width: 30, height: 30,
                              ),
                              Text(
